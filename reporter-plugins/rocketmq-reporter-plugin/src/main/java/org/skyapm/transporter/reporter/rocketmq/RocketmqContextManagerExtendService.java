...
public class RocketmqContextManagerExtendService extends ContextManagerExtendService implements RocketmqConnectionStatusListener {

    @Override
    public void prepare() {
        ServiceManager.INSTANCE.findService(RocketmqProducerManager.class).addListener(this);
    }
